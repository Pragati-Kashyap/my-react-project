...
export default function HomeNav() {
  ...
  <div className="container">
    <div className="icon  me-2">
      <img src="https://themewagon.github.io/alazea/img/core-img/logo.png" alt="Logo" />
    </div>
    ...
    <div className="collapse navbar-collapse" id="navbarCollapse">
      <ul className="navbar-nav ms-auto">
        {menuItems.map((item, index) => (
          <li key={index}>
            {item === "Pages" ? (
              <NavDropdown title="Pages" id="basic-nav-dropdown" menuAlign="right">
              ...
              <Link to={`/${item.toLowerCase()}`} className="nav-item nav-link" key={index}>
                {item}
              </Link>
            )}
          </li>
